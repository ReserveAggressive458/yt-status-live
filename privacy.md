...
## 5. Developer log access

As the app developer, Reddit's Devvit platform grants access to stream operational logs from any subreddit where the app is installed. These logs contain: the subreddit name, YouTube video IDs, Reddit post IDs, and error messages generated by the app. They do not contain post content, usernames, or any information about subreddit members.

Logs are used solely for diagnosing issues with the app and are not stored, shared, or used for any other purpose.
